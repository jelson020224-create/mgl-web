...
export default function AccountDanger() {
  ...
  return (
    <div className="card-modern border border-red-200 shadow-soft p-6">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          <h3 className="font-bold text-warm-gray text-base">Danger Zone</h3>
            ...
            <div className="mt-4 space-y-3">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  disabled={pending}
                  className="px-5 py-2 text-sm font-medium text-warm-gray bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors"
                >
                  Cancel
                </button>
              </div>
