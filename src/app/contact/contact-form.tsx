      ...
      <section className="relative bg-warm-gray text-white overflow-hidden hero-section">
        ...
        <div className="section-container relative text-center">
          <AnimateOnScroll type="fade-up">
            <span className="section-eyebrow text-terracotta/80">{settings.contact_hero_eyebrow || 'Get in Touch'}</span>
            <h1 className="text-4xl md:text-6xl font-bold font-serif leading-[1.05] mb-5">
              {settings.contact_hero_title || (<>Contact <span className="gradient-text">Us</span></>)}
            </h1>
            <p className="text-lg text-gray-light/60 font-light">{settings.contact_hero_subtitle || "Let's bring your vision to life"}</p>
          </AnimateOnScroll>
        </div>
      </section>
            ...
            <AnimateOnScroll type="fade-up" className="lg:col-span-2">
              <div className="space-y-8">
                ...
                <div className="space-y-6">
                  {[
                    { icon: 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z', label: 'Email', value: settings.company_email || 'info@mglconstruction.com', href: `mailto:${settings.company_email || 'info@mglconstruction.com'}` },
                    { icon: 'M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z', label: 'Phone', value: settings.company_phone || '(123) 456-7890', href: `tel:${settings.company_phone || '+1234567890'}` },
                    { icon: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z', label: 'Address', value: settings.company_address || '123 Construction Ave, Building City', href: null },
                  ].map((item) => (
